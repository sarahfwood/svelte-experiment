...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t2 = text(/*d*/ ctx[0]);
    			add_location(h2, file, 4, 0, 47);
    			add_location(p, file, 5, 0, 61);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*d*/ 1) set_data_dev(t2, /*d*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    ...
    class Nested extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { d: 0 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-w5b21u");
    			add_location(button, file$1, 5, 2, 104);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Nested, name, paragraphTest, src, Button });
