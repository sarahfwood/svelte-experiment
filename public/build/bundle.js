...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$1, 8, 1, 177);
    			attr_dev(h1, "class", "svelte-716gke");
    			add_location(h1, file$1, 9, 2, 206);
    			if (img.src !== (img_src_value = /*src*/ ctx[1])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "placeholder image");
    			add_location(img, file$1, 10, 2, 223);
    			attr_dev(p1, "class", "svelte-716gke");
    			add_location(p1, file$1, 11, 2, 261);
    			attr_dev(main, "class", "svelte-716gke");
    			add_location(main, file$1, 7, 0, 169);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Nested, name, paragraphTest, src });
